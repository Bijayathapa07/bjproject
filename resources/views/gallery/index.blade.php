...
<table id="mytable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{route('gallery.edit',$gallery->id)}}" class="bg-blue-600 px-2 py-1 rounded text-white">Edit</a>
                <a onclick="return confirm('Are you sure want to delete ?')" href="{{route('gallery.destroy',$gallery->id)}}" class="bg-red-600 px-2 py-1 rounded text-white">Delete</a>
            </td>
        </tr>
        @endforeach
    </tbody>
